        ...
        <div className="pt-32 pb-24 bg-[#fcfcfc] min-h-screen overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-24">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-5">
                            ...
                            >
                                CALL TECHNICAL CONSULTANT <Phone size={24} />
                            </motion.a>
                            <motion.a
                                whileHover={{ x: 15 }}
                        ...
                        <div className="p-8 bg-slate-50 border-l-[10px] border-[#0f172a] flex items-start gap-4 shadow-sm">
                            ...
                            <p className="text-[#0f172a] font-bold text-sm leading-relaxed uppercase tracking-tight">
                                Verma Prime Properties & Construction ensures 100% data privacy. Your project details are secure with our structural vault.
                            </p>
                        </div>
                    </motion.div>
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="relative group pt-16 pb-20 px-4 md:px-0"
                >
                    {/* Label Tag */}
                    <div className="absolute top-6 left-1/2 -translate-x-1/2 md:left-10 md:translate-x-0 bg-[#0f172a] text-[#f59e0b] px-8 py-3 font-black text-[10px] uppercase tracking-[0.4em] z-20 shadow-2xl border-b-4 border-[#f59e0b]">
                        Precision Location Tracking
                    </div>

                    {/* Map Container */}
                    <div className="relative h-[450px] md:h-[600px] w-full max-w-7xl mx-auto bg-white overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.2)] border-[8px] md:border-[15px] border-white outline outline-1 outline-slate-200">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3681.2704381912!2d75.8362!3d22.6814!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjLCsDQwJzUzLjAiTiA3NcKwNTAnMTAuMyJF!5e0!3m2!1sen!2sin!4v1708850000000!5m2!1sen!2sin"
                            width="100%"
                            height="100%"
                            style={{ border: 0 }}
                            allowFullScreen=""
                        ...
                        {/* Overlay Grid Pattern (Optional - For more Industrial Look) */}
                    ...
                    <div className="absolute -bottom-6 -left-10 text-[12rem] md:text-[18rem] font-black text-[#0f172a]/[0.03] select-none pointer-events-none hidden lg:block uppercase tracking-tighter">
                        Indore
                    </div>

                    <div className="absolute -bottom-6 -right-10 text-[12rem] md:text-[18rem] font-black text-[#f59e0b]/[0.03] select-none pointer-events-none hidden lg:block uppercase tracking-tighter">
                        MP09
                    </div>
                </motion.div>
            </div>
